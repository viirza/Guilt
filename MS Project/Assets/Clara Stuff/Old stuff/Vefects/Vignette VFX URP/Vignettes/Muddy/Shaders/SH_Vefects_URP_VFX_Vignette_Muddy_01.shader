...
Shader "Vefects/SH_Vefects_URP_VFX_Vignette_Muddy_01"
{
	Properties
	{
		...
		_ColorLight("Color Light", Color) = (0.372549,0.282353,0.1803922,0)
		_ColorDark("Color Dark", Color) = (0.1921569,0.1607843,0.1411765,0)
		...
		_SpecsOpacity("Specs Opacity", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float randomUV342 = IN.ase_texcoord5.z;
				float4 tex2DNode275 = tex2D( _NoiseTexture, ( ( texCoord325 * _NoiseUVScale ) + randomUV342 ) );
				float2 uv_MudTexture = IN.ase_texcoord4.xy * _MudTexture_ST.xy + _MudTexture_ST.zw;
				float4 tex2DNode271 = tex2D( _MudTexture, uv_MudTexture );
				float2 appendResult272 = (float2(tex2DNode271.r , tex2DNode271.g));
				float temp_output_324_0 = saturate( IN.ase_texcoord4.z );
				float4 fetchOpaqueVal259 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ( (ase_grabScreenPosNorm).xy + ( saturate( ( saturate( ( ( tex2DNode275.g * ( ( appendResult272 + -0.5 ) * 2.0 ) ) * _NormalStrength ) ) * tex2DNode271.b ) ) * temp_output_324_0 ) ) ), 1.0 );
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 ase_worldNormal = IN.ase_texcoord6.xyz;
				float3 normalizedWorldNormal = normalize( ase_worldNormal );
				float op312 = max( ( tex2DNode275.g * tex2DNode271.b ) , ( tex2DNode271.a * _SpecsOpacity ) );
				float2 temp_cast_0 = (op312).xx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float randomUV342 = IN.ase_texcoord3.z;
				float4 tex2DNode275 = tex2D( _NoiseTexture, ( ( texCoord325 * _NoiseUVScale ) + randomUV342 ) );
				float2 uv_MudTexture = IN.ase_texcoord2.xy * _MudTexture_ST.xy + _MudTexture_ST.zw;
				float4 tex2DNode271 = tex2D( _MudTexture, uv_MudTexture );
				float op312 = max( ( tex2DNode275.g * tex2DNode271.b ) , ( tex2DNode271.a * _SpecsOpacity ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float randomUV342 = IN.ase_texcoord1.z;
				float4 tex2DNode275 = tex2D( _NoiseTexture, ( ( texCoord325 * _NoiseUVScale ) + randomUV342 ) );
				float2 uv_MudTexture = IN.ase_texcoord.xy * _MudTexture_ST.xy + _MudTexture_ST.zw;
				float4 tex2DNode271 = tex2D( _MudTexture, uv_MudTexture );
				float op312 = max( ( tex2DNode275.g * tex2DNode271.b ) , ( tex2DNode271.a * _SpecsOpacity ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float randomUV342 = IN.ase_texcoord2.z;
				float4 tex2DNode275 = tex2D( _NoiseTexture, ( ( texCoord325 * _NoiseUVScale ) + randomUV342 ) );
				float2 uv_MudTexture = IN.ase_texcoord1.xy * _MudTexture_ST.xy + _MudTexture_ST.zw;
				float4 tex2DNode271 = tex2D( _MudTexture, uv_MudTexture );
				float op312 = max( ( tex2DNode275.g * tex2DNode271.b ) , ( tex2DNode271.a * _SpecsOpacity ) );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.CommentaryNode;341;-4544.344,-620.6697;Inherit;False;548;257.3334;Random UV;2;343;342;Random UV;0,0,0,1;0;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;343;-4494.344,-570.6697;Inherit;False;1;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;327;-3328,-640;Inherit;False;Property;_NoiseUVScale;Noise UV Scale;9;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RegisterLocalVarNode;342;-4238.344,-570.6697;Inherit;False;randomUV;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;326;-3328,-768;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;346;-3120,-640;Inherit;False;342;randomUV;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;345;-3072,-768;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;275;-2944,-768;Inherit;True;Property;_NoiseTexture;Noise Texture;8;0;Create;True;0;0;0;False;3;Space(33);Header(Noise);Space(13);False;-1;96dcce1503826c54480ca5fa7f3190a2;96dcce1503826c54480ca5fa7f3190a2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;335;-2816,-112;Inherit;False;Property;_SpecsOpacity;Specs Opacity;17;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;271;-2944,-512;Inherit;True;Property;_MudTexture;Mud Texture;0;0;Create;True;0;0;0;False;0;False;-1;9811522a52331a94dadeb2326e79292d;9811522a52331a94dadeb2326e79292d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;334;-2560,-256;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;285;-2432,-384;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;117;-256,256;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;244;-1920,-1792;Inherit;False;Property;_ColorLight;Color Light;1;0;Create;True;0;0;0;False;0;False;0.372549,0.282353,0.1803922,0;0.372549,0.282353,0.1803922,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;246;-1920,-1536;Inherit;False;Property;_ColorDark;Color Dark;2;0;Create;True;0;0;0;False;0;False;0.1921569,0.1607843,0.1411765,0;0.1921569,0.1607843,0.1411765,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;277;-2944,-896;Inherit;False;Property;_NormalOpacityNoise;Normal Opacity Noise;10;0;Create;True;0;0;0;False;0;False;0.75;0.75;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;278;-1792,-768;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;279;-1792,-640;Inherit;False;Property;_NormalStrength;Normal Strength;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;322;-1536,-768;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;252;-1664,-1024;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;336;-1920,-1024;Inherit;False;False;True;False;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;254;-2048,-1280;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;338;-1648,-1280;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;337;-1792,-1280;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;340;-3072,-1056;Inherit;False;312;op;1;0;OBJECT;;False;1;FLOAT;0
...
WireConnection;252;0;336;0
WireConnection;336;0;271;3
...
ASEEND*/
//CHKSM=07E80A89F33B2A077281472CC8D262E5E6C39D3C