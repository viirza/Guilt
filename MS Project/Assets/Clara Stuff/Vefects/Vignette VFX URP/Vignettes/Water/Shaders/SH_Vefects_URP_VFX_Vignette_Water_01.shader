	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float randomUV533 = IN.ase_texcoord5.z;
				...
				float lerpResult453 = lerp( 1.0 , _DistortionMaxMultiplier , ( saturate( temp_output_503_0 ) * saturate( IN.ase_texcoord4.z ) ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float lerpResult493 = lerp( ( 1.0 - temp_output_486_0 ) , temp_output_486_0 , _DripsDirection);
				float2 appendResult485 = (float2(texCoord442.x , lerpResult493));
				float randomUV533 = IN.ase_texcoord3.z;
				float2 panner439 = ( 1.0 * _Time.y * _DripsSpeed + ( appendResult485 + randomUV533 ));
				float4 tex2DNode437 = tex2D( _DripsMaskTexture, panner439 );
				float dripsAlpha484 = ( tex2DNode437.g * tex2DNode474.a );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float lerpResult493 = lerp( ( 1.0 - temp_output_486_0 ) , temp_output_486_0 , _DripsDirection);
				float2 appendResult485 = (float2(texCoord442.x , lerpResult493));
				float randomUV533 = IN.ase_texcoord1.z;
				float2 panner439 = ( 1.0 * _Time.y * _DripsSpeed + ( appendResult485 + randomUV533 ));
				float4 tex2DNode437 = tex2D( _DripsMaskTexture, panner439 );
				float dripsAlpha484 = ( tex2DNode437.g * tex2DNode474.a );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float lerpResult493 = lerp( ( 1.0 - temp_output_486_0 ) , temp_output_486_0 , _DripsDirection);
				float2 appendResult485 = (float2(texCoord442.x , lerpResult493));
				float randomUV533 = IN.ase_texcoord2.z;
				float2 panner439 = ( 1.0 * _Time.y * _DripsSpeed + ( appendResult485 + randomUV533 ));
				float4 tex2DNode437 = tex2D( _DripsMaskTexture, panner439 );
				float dripsAlpha484 = ( tex2DNode437.g * tex2DNode474.a );
...
Node;AmplifyShaderEditor.SamplerNode;474;-4096,1664;Inherit;True;Property;_DripsTexture;Drips Texture;1;0;Create;True;0;0;0;False;3;Space(33);Header(Drips Texture);Space(13);False;-1;7ca24e83e4f79d343ab09ac9a8f99812;7ca24e83e4f79d343ab09ac9a8f99812;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=B12D203BB12D388A6283424B58D457E1A401CE5D