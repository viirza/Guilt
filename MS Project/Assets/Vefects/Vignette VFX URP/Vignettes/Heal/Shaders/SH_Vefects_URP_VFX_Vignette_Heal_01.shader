...
Shader "Vefects/SH_Vefects_URP_VFX_Vignette_Heal_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float randomUV246 = IN.ase_texcoord4.z;
				...
				float2 temp_cast_3 = (( ( saturate( ( ( ( tex2D( _SmokeTexture, ( ( _SmokeUVScale * appendResult90_g56 ) + randomUV246 ) ).g * _SmokeMultiply ) + temp_output_133_0 ) * saturate( ( pow( temp_output_133_0 , lerpResult224 ) * _EdgeMaskMultiply ) ) ) ) * _LUTRange ) + _LUTOffset )).xx;
				float2 panner242 = ( 1.0 * _Time.y * temp_cast_0 + temp_cast_3);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( saturate( IN.ase_texcoord3.z ) * tex2D( _LUT, panner242 ) ).rgb;
				float Alpha = 1;
...
Node;AmplifyShaderEditor.CommentaryNode;245;-4892.115,299.7444;Inherit;False;548;257.3334;Random UV;2;247;246;Random UV;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;109;-640,-640;Inherit;True;Property;_LUT;LUT;3;0;Create;True;0;0;0;False;3;Space(33);Header(LUT);Space(13);False;-1;0e1bc19d1cbd7b5408a89f37e3a9439e;0e1bc19d1cbd7b5408a89f37e3a9439e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;237;-528,-48;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;244;-1024,-128;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;246;-4586.115,349.7444;Inherit;False;randomUV;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;247;-4842.115,349.7444;Inherit;False;1;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;248;-3152,-368;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;249;-3063.124,-242.7245;Inherit;False;246;randomUV;1;0;OBJECT;;False;1;FLOAT;0
...
WireConnection;239;0;114;0
WireConnection;239;1;240;0
WireConnection;109;1;242;0
WireConnection;237;0;244;0
WireConnection;237;1;109;0
WireConnection;244;0;110;3
WireConnection;246;0;247;3
WireConnection;248;0;219;100
WireConnection;248;1;249;0
WireConnection;1;2;237;0
ASEEND*/
//CHKSM=16C62043521C2DC1C17934C2EFBC2E29A54EAFD1