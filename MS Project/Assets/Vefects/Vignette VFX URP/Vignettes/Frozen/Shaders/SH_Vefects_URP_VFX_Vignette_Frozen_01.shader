...
Shader "Vefects/SH_Vefects_URP_VFX_Vignette_Frozen_01"
{
	Properties
	{
		...
		_NoiseTileX("Noise Tile X", Float) = 2
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_208_0 = ( tex2D( _SmokeTexture, ( ( _SmokeUVScale * appendResult90_g56 ) + randomUV245 ) ).g * _SmokeMultiply );
				float2 texCoord2_g57 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult12_g57 = (float2(_NoiseTileX , _NoiseTileY));
				float2 appendResult13_g57 = (float2(randomUV245 , randomUV245));
				float4 tex2DNode124 = tex2D( _NoiseTexture, ( float3( ( ( texCoord2_g57 * appendResult12_g57 ) + appendResult13_g57 ) ,  0.0 ) + float3(0,0,0) ).xy );
				float2 temp_cast_3 = (( ( ( ( temp_output_208_0 * 0.1 ) + tex2DNode124.g ) * _LUTRange ) + _LUTOffset )).xx;
				...
				float2 temp_output_26_0_g55 = ( texCoord27_g55 - temp_cast_5 );
				...
				float2 appendResult3_g53 = (float2((appendResult5_g55).x , ( ( distance( max( ( abs( ( texCoord11_g53 + -0.5 ) ) - ( float2( 0.15,0.15 ) * 0.5 ) ) , float2( 0,0 ) ) , temp_cast_6 ) + _EdgeMaskOffset ) * 1.5 )));
				...
				float Alpha = saturate( ( IN.ase_texcoord3.z * saturate( ( ( ( temp_output_208_0 + tex2DNode124.g ) + temp_output_133_0 ) * saturate( ( pow( temp_output_133_0 , lerpResult224 ) * _EdgeMaskMultiply ) ) ) ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float temp_output_208_0 = ( tex2D( _SmokeTexture, ( ( _SmokeUVScale * appendResult90_g56 ) + randomUV245 ) ).g * _SmokeMultiply );
				float2 texCoord2_g57 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult12_g57 = (float2(_NoiseTileX , _NoiseTileY));
				float2 appendResult13_g57 = (float2(randomUV245 , randomUV245));
				float4 tex2DNode124 = tex2D( _NoiseTexture, ( float3( ( ( texCoord2_g57 * appendResult12_g57 ) + appendResult13_g57 ) ,  0.0 ) + float3(0,0,0) ).xy );
				float2 texCoord27_g55 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_2 = (1.0).xx;
				float2 temp_output_26_0_g55 = ( texCoord27_g55 - temp_cast_2 );
				float temp_output_13_0_g55 = frac( ( atan2( (temp_output_26_0_g55).x , (temp_output_26_0_g55).y ) / 6.283 ) );
				float2 temp_output_17_0_g55 = ( temp_output_26_0_g55 * temp_output_26_0_g55 );
				float temp_output_12_0_g55 = sqrt( ( (temp_output_17_0_g55).x + (temp_output_17_0_g55).y ) );
				float2 appendResult5_g55 = (float2(temp_output_13_0_g55 , temp_output_12_0_g55));
				...
				float2 appendResult3_g53 = (float2((appendResult5_g55).x , ( ( distance( max( ( abs( ( texCoord11_g53 + -0.5 ) ) - ( float2( 0.15,0.15 ) * 0.5 ) ) , float2( 0,0 ) ) , temp_cast_3 ) + _EdgeMaskOffset ) * 1.5 )));
				float temp_output_133_0 = (appendResult3_g53).y;
				float lerpResult224 = lerp( 60.0 , _EdgeMaskPower , ( 1.0 - pow( ( 1.0 - _VignetteON ) , 3.0 ) ));
				

				float Alpha = saturate( ( IN.ase_texcoord2.z * saturate( ( ( ( temp_output_208_0 + tex2DNode124.g ) + temp_output_133_0 ) * saturate( ( pow( temp_output_133_0 , lerpResult224 ) * _EdgeMaskMultiply ) ) ) ) ) );
				float AlphaClipThreshold = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_208_0 = ( tex2D( _SmokeTexture, ( ( _SmokeUVScale * appendResult90_g56 ) + randomUV245 ) ).g * _SmokeMultiply );
				float2 texCoord2_g57 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult12_g57 = (float2(_NoiseTileX , _NoiseTileY));
				float2 appendResult13_g57 = (float2(randomUV245 , randomUV245));
				float4 tex2DNode124 = tex2D( _NoiseTexture, ( float3( ( ( texCoord2_g57 * appendResult12_g57 ) + appendResult13_g57 ) ,  0.0 ) + float3(0,0,0) ).xy );
				...
				surfaceDescription.Alpha = saturate( ( IN.ase_texcoord.z * saturate( ( ( ( temp_output_208_0 + tex2DNode124.g ) + temp_output_133_0 ) * saturate( ( pow( temp_output_133_0 , lerpResult224 ) * _EdgeMaskMultiply ) ) ) ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_208_0 = ( tex2D( _SmokeTexture, ( ( _SmokeUVScale * appendResult90_g56 ) + randomUV245 ) ).g * _SmokeMultiply );
				float2 texCoord2_g57 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult12_g57 = (float2(_NoiseTileX , _NoiseTileY));
				float2 appendResult13_g57 = (float2(randomUV245 , randomUV245));
				float4 tex2DNode124 = tex2D( _NoiseTexture, ( float3( ( ( texCoord2_g57 * appendResult12_g57 ) + appendResult13_g57 ) ,  0.0 ) + float3(0,0,0) ).xy );
				...
				surfaceDescription.Alpha = saturate( ( IN.ase_texcoord1.z * saturate( ( ( ( temp_output_208_0 + tex2DNode124.g ) + temp_output_133_0 ) * saturate( ( pow( temp_output_133_0 , lerpResult224 ) * _EdgeMaskMultiply ) ) ) ) ) );
				surfaceDescription.AlphaClipThreshold = 0.5;
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.CommentaryNode;244;-4896,80;Inherit;False;548;257.3334;Random UV;2;246;245;Random UV;0,0,0,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;226;-3200,1408;Inherit;False;Property;_VignetteON;Vignette ON;13;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;246;-4848,144;Inherit;False;1;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;228;-2992,1408;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;222;-4096,-384;Inherit;False;Property;_SmokeUVSwirl;Smoke UV Swirl;17;0;Create;True;0;0;0;False;0;False;0.3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;196;-4096,-256;Inherit;False;Property;_SmokeUVScale;Smoke UV Scale;15;0;Create;True;0;0;0;False;0;False;2,0.1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;203;-4096,-128;Inherit;False;Property;_SmokeUVPanSpeed;Smoke UV Pan Speed;16;0;Create;True;0;0;0;False;0;False;0.1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RegisterLocalVarNode;245;-4592,144;Inherit;False;randomUV;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;227;-2816,1408;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;130;-3200,1024;Inherit;False;Property;_EdgeMaskOffset;Edge Mask Offset;12;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;247;-3520,-48;Inherit;False;245;randomUV;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;135;-2560,1280;Inherit;False;Property;_EdgeMaskPower;Edge Mask Power;10;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;178;-4096,-640;Inherit;True;Property;_SmokeTexture;Smoke Texture;14;0;Create;True;0;0;0;False;3;Space(33);Header(Smoke);Space(13);False;4ad233d79215d284aae54c3d45caf987;96dcce1503826c54480ca5fa7f3190a2;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;234;-4096,384;Inherit;False;Property;_NoiseTileY;Noise Tile Y;9;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;233;-4096,256;Inherit;False;Property;_NoiseTileX;Noise Tile X;8;0;Create;True;0;0;0;False;0;False;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;248;-3136,-368;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;202;-2944,-768;Inherit;False;Property;_SmokeMultiply;Smoke Multiply;18;0;Create;True;0;0;0;False;0;False;0.1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;232;-3840,256;Inherit;False;SH_F_Vefects_VFX_UVControls;-1;;57;646903c10e8abfe49bda8ebf1a207339;0;6;1;FLOAT2;0,0;False;4;FLOAT;0;False;7;FLOAT;0;False;9;FLOAT;0;False;11;FLOAT;0;False;16;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.PowerNode;131;-2304,1024;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;136;-2048,1152;Inherit;False;Property;_EdgeMaskMultiply;Edge Mask Multiply;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;208;-2944,-640;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;124;-3456,256;Inherit;True;Property;_NoiseTexture;Noise Texture;7;0;Create;True;0;0;0;False;3;Space(33);Header(Noise);Space(13);False;-1;f189a42c3a428034691438da050dceed;f189a42c3a428034691438da050dceed;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;132;-2048,1024;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;230;-2304,256;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;223;-1792,1024;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;231;-2176,256;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;109;-640,-640;Inherit;True;Property;_LUT;LUT;3;0;Create;True;0;0;0;False;3;Space(33);Header(LUT);Space(13);False;-1;00816448001c4f8489fee7c25d462a72;00816448001c4f8489fee7c25d462a72;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;235;-2560,-640;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;236;-2304,-640;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=887F958D7BECD714AA805231C7E13AD7B9BBBAD7