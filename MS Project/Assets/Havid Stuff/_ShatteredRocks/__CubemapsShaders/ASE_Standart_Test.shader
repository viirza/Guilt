	...
	SubShader
	{
		...
		Pass
        {
					...
					)
			{
				...
				float3 ase_tanViewDir =  tanToWorld0 * ase_worldViewDir.x + tanToWorld1 * ase_worldViewDir.y  + tanToWorld2 * ase_worldViewDir.z;
				ase_tanViewDir = normalize(ase_tanViewDir);
				float2 OffsetPOM98 = POM( _HeightMap, texCoord17, ddx(texCoord17), ddy(texCoord17), packedInput.normalWS, ase_worldViewDir, ase_tanViewDir, 8, 8, ( 0.001 * _ParalaxOffset ), 0.5, _HeightMap_ST.xy, float2(0,0), 0 );
				float4 tex2DNode1 = tex2D( _Albedo, OffsetPOM98 );
...
Node;AmplifyShaderEditor.RangedFloatNode;136;586.4188,56.34479;Inherit;False;Property;_Float1;Float 1;18;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
WireConnection;125;9;1;4
WireConnection;125;10;136;0
WireConnection;34;0;3;0
WireConnection;34;1;33;4
ASEEND*/
//CHKSM=92FEC6FD3B70133715FC25BB7368A0A4C0C01B6B