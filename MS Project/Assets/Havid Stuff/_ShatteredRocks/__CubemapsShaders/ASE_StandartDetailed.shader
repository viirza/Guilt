...
Shader "ASE/ASE_StandartDetailed"
{
	...
	SubShader
	{
		...
		uniform sampler2D _NormalDetails;
		uniform float4 _NormalDetails_ST;
		uniform float _NormalDStrenth;
		uniform sampler2D _Albedo;
		uniform float4 _AlbedoColor;
		uniform sampler2D _AlbedoD;
		uniform float4 _AlbedoD_ST;
		uniform float _AlbedoDStrenth;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_NormalDetails = i.uv_texcoord * _NormalDetails_ST.xy + _NormalDetails_ST.zw;
			float3 lerpResult120 = lerp( tex2DNode13 , BlendNormals( tex2DNode13 , UnpackNormal( tex2D( _NormalDetails, uv_NormalDetails ) ) ) , _NormalDStrenth);
			o.Normal = lerpResult120;
			float4 temp_output_3_0 = ( tex2D( _Albedo, OffsetPOM98 ) * _AlbedoColor );
			float2 uv_AlbedoD = i.uv_texcoord * _AlbedoD_ST.xy + _AlbedoD_ST.zw;
			float4 tex2DNode128 = tex2D( _AlbedoD, uv_AlbedoD );
			float4 lerpResult129 = lerp( temp_output_3_0 , ( tex2DNode128 * temp_output_3_0 ) , _AlbedoDStrenth);
...
Node;AmplifyShaderEditor.SamplerNode;33;-608.5511,-278.098;Inherit;True;Property;_EmissionMap;EmissionMap;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;13;-953.9689,-572.1139;Inherit;True;Property;_NormalMap;NormalMap;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;11;-515.8754,163.1064;Float;False;Property;_SmoothRough;Smooth/Rough;8;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;132;2;37;0
WireConnection;132;3;7;0
WireConnection;132;4;10;0
...
ASEEND*/
//CHKSM=9EFABBE65B85F4AFE361B772BD7C902B08976F07