	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float4 Colour18 = ( _Colour * IN.ase_color );
				
				float2 texCoord11_g10 = IN.ase_texcoord4.xy * float2( 2,2 ) + float2( -1,-1 );
				...
				float2 texCoord7_g8 = IN.ase_texcoord4.xy * float2( 2,2 ) + float2( -1,-1 );
				...
				float Radial_Light196 = lerpResult100;
				...
				float Alpha25 = ( Radial_Light196 * (Colour18).a * Depth_Fade108 * Camera_Depth_Fade112 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = Colour18.rgb;
				float Alpha = Alpha25;
...
/*ASEBEGIN
Version=19701
Node;AmplifyShaderEditor.RangedFloatNode;14;-768,0;Inherit;False;Property;_Feather;Feather;2;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;105;-384,224;Inherit;False;Property;_Power;Power;1;1;[Header];Create;True;0;0;0;False;2;Header(Shape);Space(10);False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;71;-768,512;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;79;-768,384;Inherit;False;Property;_LightRadius;Light Radius;4;0;Create;True;0;0;0;False;0;False;0.01;0.1;0.001;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;16;-768,-512;Inherit;False;Property;_Colour;Colour;0;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.VertexColorNode;15;-768,-320;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;80;-640,896;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;113;-768,1408;Inherit;False;Property;_CameraDepthFade;Camera Depth Fade;6;0;Create;True;0;0;0;False;2;Header(Depth Fade);Space(10);False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;114;-768,1488;Inherit;False;Property;_CameraDepthFadeOffset;Camera Depth Fade Offset;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-512,-512;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;102;-384,992;Inherit;False;Property;_InvSqFalloff;InvSq Falloff;3;1;[Header];Create;True;0;0;0;False;2;Header(Light);Space(10);False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;109;-768,1280;Inherit;False;Property;_DepthFade;Depth Fade;5;0;Create;True;0;0;0;False;2;Header(Soft Particle);Space(10);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;18;-256,-512;Inherit;False;Colour;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;96;256,768;Inherit;False;Radial Light1;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;108;-128,1280;Inherit;False;Depth Fade;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;23;-768,1920;Inherit;False;18;Colour;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;97;-512,1792;Inherit;False;96;Radial Light1;1;0;OBJECT;;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=C69B394966E5D0F172C3F69A397B88ACC8B61F09